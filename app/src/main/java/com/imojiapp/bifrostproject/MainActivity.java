package com.imojiapp.bifrostproject;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("MainActivity", is.available() + " bytes available.");
            byte[] b = new byte[is.available()];
            int bytesRead = is.read(b);
            Log.d("MainActivity", bytesRead + " bytes read into array.");

            ByteBuffer in = ByteBuffer.allocateDirect(b.length);
            in.put(b);

            // Decode, encode and decode image again to test if chain is fully functional
